...
(define-module (gnucash reports standard account-piecharts-extended))
...
(define menutip-income
  (N_ "Shows a piechart with the Income per given time interval. Extended with tags."))
(define menutip-expense
  (N_ "Shows a piechart with the Expenses per given time interval. Extended with tags."))
(define menutip-assets
  (N_ "Shows a piechart with the Assets balance at a given time. Extended with tags."))
(define menutip-securities
  (N_ "Shows a piechart with distribution of assets over securities. Extended with tags."))
(define menutip-liabilities
  (N_ "Shows a piechart with the Liabilities \
balance at a given time. Extended with tags."))
...
(build-report!
  ...
  "2c0768f752884486b214f381ce08a89a")
...
(build-report!
  ...
  "e9d48ff473654df8aa65a6c520f14c9b")
...
(build-report!
  ...
  "3641df53fbf142ff9fe3c2f7d34d73d1")
...
(build-report!
  ...
  "14dfc4af6cc047b29c4856bad4246c5d")
